...
public class ApiTwitterStreamingSpoutHBC extends BaseRichSpout {
	...
	private static final long serialVersionUID = -1036251133340187931L;
	...
	public void open(Map conf, TopologyContext context, SpoutOutputCollector collector) {
		...
		try {
			oauth("6vmb7wKsiPXNoKgGdevDg", "ZrgBsYLzZ7ojj5ezlmjAAoUq0ehBFmF1tAw6c4W25U",
					"452618044-hvKCDbM3vFTEPH1HTnh6ejXHCzIwUOA9gw4QEkG8", "4otKVfaf14taWVL0M77i3fs9DJcrxEDaydz2CyACVo");
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		this.collector = collector;
	...
	public void oauth(String consumerKey, String consumerSecret, String token, String secret)
		...
		client = new ClientBuilder().name("sampleExampleClient").hosts(Constants.STREAM_HOST).endpoint(endpoint)
