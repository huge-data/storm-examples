...
public class Topology {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		builder.setBolt("hashtags-sanitazer", new TwitterSanitazeHashtagsBolt()).shuffleGrouping("tweets-collector");
		builder.setBolt("hashtag-sumarizer", new TwitterSumarizeHashtagsBolt()).shuffleGrouping("hashtags-sanitazer");
		builder.setBolt("hashtag-storer", new TwitterStoreHashtagsBolt()).shuffleGrouping("hashtag-sumarizer");
